...
public class SensorTest {
    ...
    public void testConversionOfHumidityToTemperature() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> humiditySensor.toCelsius());
    }

    @Test
    @DisplayName("should not allow to convert precipitation to temperature")
    public void testConversionOfPrecipitationToHumidity() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> precipitationSensor.toCelsius());
    }

    @Test
    @DisplayName("should not allow to instantiate temperature with %")
    public void testCreateInvalidUnitTemperature1() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Sensor(SensorType.TEMPERATURE, UnitType.PERCENT, 0.0));
    }

    @Test
    @DisplayName("should not allow to instantiate temperature with mm")
    public void testCreateInvalidUnitTemperature2() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Sensor(SensorType.TEMPERATURE, UnitType.MILLIMETER, 0.0));
    }
    ...
    public void testCreateInvalidUnitHumidity1() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Sensor(SensorType.HUMIDITY, UnitType.CELSIUS, 0.0));
    }

    @Test
    @DisplayName("should not allow to instantiate humidity F")
    public void testCreateInvalidUnitHumidity2() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Sensor(SensorType.HUMIDITY, UnitType.FAHRENHEIT, 0.0));
    }

    @Test
    @DisplayName("should not allow to instantiate humidity with mm")
    public void testCreateInvalidUnitHumidity3() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Sensor(SensorType.HUMIDITY, UnitType.MILLIMETER, 0.0));
    }

    @Test
    @DisplayName("should not allow to instantiate precipitation with C")
    public void testCreateInvalidUnitPrecipitation1() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Sensor(SensorType.PRECIPITATION, UnitType.CELSIUS, 0.0));
    }

    @Test
    @DisplayName("should not allow to instantiate precipitation with F")
    public void testCreateInvalidUnitPrecipitation2() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Sensor(SensorType.PRECIPITATION, UnitType.FAHRENHEIT, 0.0));
    }

    @Test
    @DisplayName("should not allow to instantiate precipitation with %")
    public void testCreateInvalidUnitPrecipitation3() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new Sensor(SensorType.PRECIPITATION, UnitType.PERCENT, 0.0));
    }
